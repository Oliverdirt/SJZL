     ...
     <el-row>
        <el-col :span="12">
            <el-form-item label="数据模型名称" prop="tableName">
                <el-input v-model="addTableJson.tableName" placeholder="请输入数据模型名称" clearable />
            </el-form-item>
        </el-col>
     </el-row>
     <el-row>
        <el-col :span="12">
            <el-form-item label="数据模型描述" prop="tableContent">
                <el-input v-model="addTableJson.tableContent" placeholder="请输入数据模型描述" clearable />
            </el-form-item>
        </el-col>
     </el-row>
    </el-form>
  ...
  methods: {
    ...
    formModelBind (flag) {
      let params = {
        ...
        tableDesc: this.addTableJson.tableContent
      }
