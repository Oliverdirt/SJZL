...
} from '@/views/lowcode/utils/util'
import FormValidators from '@/views/lowcode/utils/validators'
  ...
  methods: {
    ...
    initFieldModel () {
      ...
      if (!!this.subFormItemFlag && !this.designState) {  //SubForm子表单组件需要特殊处理！！
        ...
        if (((subFormData === undefined) || (subFormData[this.subFormRowIndex] === undefined) ||
          ...
          subFormData ? (subFormData[this.subFormRowIndex][this.field.options.name] = this.field.options.defaultValue) : ''
        } else if (subFormData && (subFormData[this.subFormRowIndex][this.field.options.name] === undefined)) {
          this.fieldModel = null
          subFormData && (subFormData[this.subFormRowIndex][this.field.options.name] = null)
        } else {
          subFormData && (this.fieldModel = subFormData[this.subFormRowIndex][this.field.options.name])
        }
    ...
    handleOnCreated () {
      ...
      if (!!this.field.options.onCreated) {
        let customFunc = new Fn(this.field.options.onCreated)
    ...
    handleOnMounted () {
      ...
      if (!!this.field.options.onMounted) {
        let mountFunc = new Fn(this.field.options.onMounted)
        mountFunc.call(this)
      }
    },
    ...
    buildFieldRules () {
      ...
      if (!!this.field.options.onValidate) {
        ...
        let customFn = (rule, value, callback) => {
          let tmpFunc = new Fn('rule', 'value', 'callback', this.field.options.onValidate)
    ...
    handleFocusCustomEvent (event) {
      ...
      if (!!this.field.options.onFocus) {
        let customFn = new Fn('event', this.field.options.onFocus)
    ...
    handleBlurCustomEvent (event) {
      ...
      if (!!this.field.options.onBlur) {
        let customFn = new Fn('event', this.field.options.onBlur)
        customFn.call(this, event)
      }
    },
    ...
    handleInputCustomEvent (value) {
      ...
      if (!!this.field.options.onInput) {
        let customFn = new Fn('value', this.field.options.onInput)
    ...
    emitAppendButtonClick () {
      ...
      if (!!this.field.options.onAppendButtonClick) {
        let customFn = new Fn(this.field.options.onAppendButtonClick)
        customFn.call(this)
      } else {
    ...
    handleOnChange (val, oldVal) {  //自定义onChange事件
      ...
      if (!!this.field.options.onChange) {
        let changeFn = new Fn('value', 'oldValue', this.field.options.onChange)
    ...
    handleOnChangeForSubForm (val, oldVal, subFormData, rowId) {  //子表单自定义onChange事件
      ...
      if (!!this.field.options.onChange) {
        let changeFn = new Fn('value', 'oldValue', 'subFormData', 'rowId', this.field.options.onChange)
    ...
    handleButtonWidgetClick () {
      ...
      if (!!this.field.options.onClick) {
        let customFn = new Fn(this.field.options.onClick)
        customFn.call(this)
      } else {
    ...
    remoteQuery (keyword) {
      ...
      if (!!this.field.options.onRemoteQuery) {
        let remoteFn = new Fn('keyword', this.field.options.onRemoteQuery)
