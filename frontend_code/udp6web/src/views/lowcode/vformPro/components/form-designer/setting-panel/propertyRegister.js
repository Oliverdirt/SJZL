...
const COMMON_PROPERTIES = {
  ...
  'name'              :            'name-editor',
  'label'             :            'label-editor',
  'queryType'         :            'queryType-editor',
  'marginLeft'        :            'marginLeft-editor',
  'marginRight'       :            'marginRight-editor',
  'labelAlign'        :            'labelAlign-editor',
  'btnEventType'      :            'btnEventType-editor',
  'linkFormPage'      :            'link-editor',
  'bindInterfaceAddress'      :    'bindInterfaceAddress-editor',
  'bindResponse'              :    'bindResponse-editor',
  'bindRequestMode'   :            'bindRequestMode-editor',
  'type'              :            'type-editor',
  ...
  'marginStyle'       :            'marginStyle-editor',
