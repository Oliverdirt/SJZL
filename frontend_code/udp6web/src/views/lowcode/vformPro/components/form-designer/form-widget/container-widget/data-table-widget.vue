<template>
	...
	<container-wrapper :designer="designer" :widget="widget" :parent-widget="parentWidget" :parent-list="parentList"
		...
		<div :key="widget.id" class="collapse-container" :style="{'margin-top': widget.options.marginTop + 'px'}"
			:class="{'selected': selected}" @click.stop="selectWidget(widget)">

			<el-table :data="widget.options.tableData" ref="dataTableRef" :class="[customClass]"
								:height="tableHeight" :style="{'width': widget.options.tableWidth, 'margin-top': widget.options.marginTop}"
...
<script>
	import ContainerWrapper from "@/views/lowcode/vformPro/components/form-designer/form-widget/container-widget/container-wrapper"
  import i18n from "@/views/lowcode/utils/i18n"
	import {formatDate1, formatDate2, formatDate3, formatDate4, formatDate5,
					...
					formatNumber5, formatNumber6, formatNumber7} from "@/views/lowcode/utils/format"
	import Draggable from 'vuedraggable'
	import FieldComponents from '@/views/lowcode/vformPro/components/form-designer/form-widget/field-widget/index'
	import containerMixin from "@/views/lowcode/vformPro/components/form-designer/form-widget/container-widget/containerMixin"
	import refMixinDesign from "@/views/lowcode/vformPro/components/form-designer/refMixinDesign"
