...
<script>
  ...
  import SvgIcon from '@/views/lowcode/vformPro/components/svg-icon'
  ...
  import {generateCode} from "@/views/lowcode/utils/code-generator";
  import {genSFC} from "@/views/lowcode/utils/sfc-generator";
  import loadBeautifier from "@/views/lowcode/utils/beautifierLoader";
