...
<script>
  ...
  import {createDesigner} from "@/views/lowcode/vformPro/components/form-designer/designer"
  import {
  ...
  import {MOCK_CASE_URL, VARIANT_FORM_VERSION} from "@/views/lowcode/utils/config"
