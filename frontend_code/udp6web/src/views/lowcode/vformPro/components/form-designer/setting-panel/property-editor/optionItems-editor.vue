...
<script>
  ...
  import OptionItemsSetting from "@/views/lowcode/vformPro/components/form-designer/setting-panel/option-items-setting"
  import propertyMixin from "@/views/lowcode/vformPro/components/form-designer/setting-panel/property-editor/propertyMixin"
  import {getDSByName} from "@/views/lowcode/utils/util"
