  ...
  <div class="form-widget-container">
    ...
    <el-form class="full-height-width widget-form" :label-position="labelPosition"
      ...
      <draggable :list="designer.widgetList" v-bind="{group:'dragGroup', ghostClass: 'ghost',animation: 300}"
        ...
        <transition-group name="fade" tag="div" class="form-widget-canvas" :style="{minHeight: canvasMinHeight}">
...
<script>
  ...
  import '@/views/lowcode/vformPro/components/form-designer/form-widget/container-widget/index'
