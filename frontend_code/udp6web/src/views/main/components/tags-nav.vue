...
<template>
  <div class="tags-nav">
      ...
      <div class="tags-wrapper-scroll" ref="tagsWrapperScroll" :style="{ left: leftOffset + 'px' }">
        <transition-group name="slide-fade">
          <Tag
            ...
            :class="[tag.selected ? 'tag-slected' : 'tag-unslected']"
            ref="tagsPageOpened"
    ...
    <Dropdown class="dropdown-btn" trigger="click" placement="bottom-end" @on-click="closeTags" transfer>
