            ...
            <template v-for="(menu_2, index) in menu_1.children">
                  ...
                  <template v-for="(menu_3, index) in menu_2.children">
                    <MenuItem :name="menu_3.name" :key="'menu_3_' + index" :title="menu_3.title">
                      <span class="menu-item-title"><Icon
                        :type="menu_3.icon"/>&nbsp;&nbsp;&nbsp;{{ menu_3.title }}</span>
                    </MenuItem>
                  </template>
                </Submenu>
              </template>
              <template v-else>
                <MenuItem :name="menu_2.name" :key="'menu_2_' + index" :title="menu_2.title">
                  <span class="menu-item-title"
                        :class="[activeName === menu_1.children[0].name ? 'menu-item-slected' : '']"><Icon
                    :type="menu_2.icon"/>&nbsp;&nbsp;&nbsp;{{ menu_2.title }}</span>
                </MenuItem>
              </template>
            </template>
          </Submenu>
