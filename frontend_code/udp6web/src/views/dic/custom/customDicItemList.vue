...
export default {
  ...
  methods: {
    ...
    remove (row, index) {
      this.$Modal.confirm({
        ...
        onOk: () => {
          ...
          // this.$http.delete('/api/dic/cscpHxDicItems/' + row.itemId)
            .then(res => {
              if (res.data.msg) {
      ...
      this.$refs['itemDetail'].validate((valid) => {
        if (valid) {
          if (type === 'update') {
            ...
            // this.$http.put('/api/dic/cscpHxDicItems', copyDetail)
              .then(res => {
            ...
            // this.$http.post('/api/dic/cscpHxDicItems', copyDetail)
              .then(res => {
    ...
    queryList () {
      ...
      // this.$http.get('api/dic/cscpHxDicItems', {
      //   params: params
      // })
        .then(res => {
    ...
    handleDeleteMultiple () {
      ...
      this.$Modal.confirm({
        ...
        onOk: () => {
          delDicItemByIds(arr)
          // this.$http.delete('/api/dic/cscpHxDicItems/delAll?itemIds=' + arr)
            .then(res => {
