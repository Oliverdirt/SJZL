...
import com.ctsi.ssdc.errorcode.exception.pojo.PageParam;
...
import static com.ctsi.ssdc.errorcode.util.DateUtils.FORMAT_YEAR_MONTH_DAY_HOUR_MINUTE_SECOND;
...
public class ErrorCodePageReqVO extends PageParam {
    ...
    private ZonedDateTime beginCreateTime;

    @DateTimeFormat(pattern = FORMAT_YEAR_MONTH_DAY_HOUR_MINUTE_SECOND)
    @ApiModelProperty(value = "结束创建时间")
    private ZonedDateTime endCreateTime;
