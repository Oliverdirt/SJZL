...
public class BadRequestAlertException extends AbstractThrowableProblem {
    ...
    private static final long serialVersionUID = 2658938450405809980L;
    ...
    public BadRequestAlertException(URI type, String title, String entityName, String errorKey) {
        super(type, title, Status.BAD_REQUEST, null, null, null, getAlertParameters(entityName, errorKey));
