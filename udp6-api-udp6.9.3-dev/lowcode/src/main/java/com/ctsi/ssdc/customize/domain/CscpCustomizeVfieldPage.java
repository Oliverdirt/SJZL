...
public class CscpCustomizeVfieldPage implements Serializable{
    /**
     * 字段id
     *
     */
    ...
    public boolean equals(Object that){
        ...
        CscpCustomizeVfieldPage other=(CscpCustomizeVfieldPage)that;
        return (this.getFieldId() ==null?this.getFieldId() !=null:this.getFieldId().equals(other.getFieldId()))
                && (this.getPageId() ==null?this.getPageId() !=null:this.getPageId().equals(other.getPageId()))
