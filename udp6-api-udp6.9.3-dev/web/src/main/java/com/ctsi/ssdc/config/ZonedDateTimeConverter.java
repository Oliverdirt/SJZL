    ...
    public Converter<String, ZonedDateTime> zonedDateTimeConvert() {
        return new Converter<String, ZonedDateTime>() {
            ...
            public ZonedDateTime convert(String source) {
                ...
                df = DateTimeFormatter.ofPattern("yyyy-MM-dd HH:mm:ss").withZone(ZoneId.of("GMT+08:00"));
                ZonedDateTime date = null;
                try {
                	date = ZonedDateTime.parse(source, df).withZoneSameInstant(ZoneId.of("GMT+08:00"));
                } catch (Exception e) {
