...
import com.ctsi.flow.param.model.CscpRoleActExample.Criteria;
import com.ctsi.flow.param.model.CscpRoleActExample.Criterion;
...
/**
 * CscpRoleActSqlProvider
 *
 * @author hx
 * @date 2022-07-26 15:53:56
*/

public class CscpRoleActSqlProvider {

    /**
     * This method was generated by  Generator.
     * This method corresponds to the database table cscp_role_act
     */
    public String countByExample(CscpRoleActExample example) {
        SQL sql = new SQL();
        sql.SELECT("count(*)").FROM("cscp_role_act");
     ...
     * This method corresponds to the database table cscp_role_act
     */
    public String deleteByExample(CscpRoleActExample example) {
        SQL sql = new SQL();
        sql.DELETE_FROM("cscp_role_act");
        applyWhere(sql, example, false);
        return sql.toString();
    }
     ...
     * This method corresponds to the database table cscp_role_act
     */
    public String insertSelective(CscpRoleAct record) {
        SQL sql = new SQL();
        sql.INSERT_INTO("cscp_role_act");
     ...
     * This method corresponds to the database table cscp_role_act
     */
    public String selectByExample(CscpRoleActExample example) {
        SQL sql = new SQL();
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        CscpRoleAct record = (CscpRoleAct) parameter.get("record");
        CscpRoleActExample example = (CscpRoleActExample) parameter.get("example");

        SQL sql = new SQL();
        sql.UPDATE("cscp_role_act");
     ...
     * This method corresponds to the database table cscp_role_act
     */
    public String updateByPrimaryKeySelective(CscpRoleAct record) {
        SQL sql = new SQL();
        sql.UPDATE("cscp_role_act");
     ...
     * This method corresponds to the database table cscp_role_act
     */
    protected void applyWhere(SQL sql, CscpRoleActExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
