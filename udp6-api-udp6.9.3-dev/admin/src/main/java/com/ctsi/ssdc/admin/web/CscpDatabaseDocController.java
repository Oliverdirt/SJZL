...
@Api(tags = "管理后台 - 数据库文档")
@RestController
@RequestMapping("/api/system/db-doc")
public class CscpDatabaseDocController {
    ...
    @ComponentCallAnno(component = HxComponentConstant.ADMIN,method = "exportHtml")
    ...
    @ApiImplicitParam(name = "deleteFile", value = "是否删除在服务器本地生成的数据库文档", example = "true",
            dataTypeClass = Boolean.class)
    @ComponentCallAnno(component = HxComponentConstant.ADMIN,method = "exportWord")
    ...
    @ApiImplicitParam(name = "deleteFile", value = "是否删除在服务器本地生成的数据库文档", example = "true",
            dataTypeClass = Boolean.class)
    @ComponentCallAnno(component = HxComponentConstant.ADMIN,method = "exportMarkdown")
    ...
    private static ProcessConfig buildProcessConfig() {
        return ProcessConfig.builder()
                // 忽略表前缀
                .ignoreTablePrefix(Arrays.asList("QRTZ_","qrtz_", "ACT_","act_",
                        "databasechangelog"))
                .build();
    }
