...
import com.ctsi.ssdc.admin.domain.CscpUserExample.Criterion;

/**
 * @author MyBatis Generator
*/
public class CscpUserSqlProvider {
     ...
     */
    public String countByExample(CscpUserExample example) {
        SQL sql = new SQL();
        sql.SELECT("count(*)").FROM("cscp_user");
     ...
     * @mbg.generated Mon Apr 23 08:56:34 CST 2018
     */
    public String deleteByExample(CscpUserExample example) {
        SQL sql = new SQL();
        sql.DELETE_FROM("cscp_user");
        applyWhere(sql, example, false);
        return sql.toString();
    }
     ...
     * @mbg.generated Mon Apr 23 08:56:34 CST 2018
     */
    public String insertSelective(CscpUser record) {
        SQL sql = new SQL();
        sql.INSERT_INTO("cscp_user");
        ...
        if (record.getPassword() != null) {
            ...
            sql.VALUES("password", record.getPassword());
        }
     ...
     * @mbg.generated Mon Apr 23 08:56:34 CST 2018
     */
    public String selectByExample(CscpUserExample example) {
        SQL sql = new SQL();
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        CscpUser record = (CscpUser) parameter.get("record");
        CscpUserExample example = (CscpUserExample) parameter.get("example");
        
        SQL sql = new SQL();
        sql.UPDATE("cscp_user");
     ...
     * @mbg.generated Mon Apr 23 08:56:34 CST 2018
     */
    public String updateByPrimaryKeySelective(CscpUser record) {
        SQL sql = new SQL();
        sql.UPDATE("cscp_user");
     ...
     * @mbg.generated Mon Apr 23 08:56:34 CST 2018
     */
    protected void applyWhere(SQL sql, CscpUserExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
     ...
     * @mbg.generated Mon Apr 23 08:56:34 CST 2018
     */
    public String selectByExampleWithPage(CscpUserExample example) {
