...
import com.ctsi.monitor.domain.MonitorJvmExample.Criteria;
import com.ctsi.monitor.domain.MonitorJvmExample.Criterion;
...
/**
 * MonitorJvmSqlProvider
 *
 * @author hx
 * @date 2022-05-27 14:02:10
*/

public class MonitorJvmSqlProvider {

    /**
     * This method was generated by  Generator.
     * This method corresponds to the database table monitor_jvm
     */
    public String countByExample(MonitorJvmExample example) {
        SQL sql = new SQL();
        sql.SELECT("count(*)").FROM("monitor_jvm");
     ...
     * This method corresponds to the database table monitor_jvm
     */
    public String deleteByExample(MonitorJvmExample example) {
        SQL sql = new SQL();
        sql.DELETE_FROM("monitor_jvm");
        applyWhere(sql, example, false);
        return sql.toString();
    }
     ...
     * This method corresponds to the database table monitor_jvm
     */
    public String insertSelective(MonitorJvm record) {
        SQL sql = new SQL();
        sql.INSERT_INTO("monitor_jvm");
        ...
        if (record.getMax() != null) {
            sql.VALUES("max", "#{max,jdbcType=DOUBLE}");
        }
     ...
     * This method corresponds to the database table monitor_jvm
     */
    public String selectByExample(MonitorJvmExample example) {
        SQL sql = new SQL();
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        MonitorJvm record = (MonitorJvm) parameter.get("record");
        MonitorJvmExample example = (MonitorJvmExample) parameter.get("example");

        SQL sql = new SQL();
        sql.UPDATE("monitor_jvm");
        ...
        if (record.getMax() != null) {
        sql.SET("max = #{max,jdbcType=DOUBLE}");
        }
        if (record.getFree() != null) {
     ...
     * This method corresponds to the database table monitor_jvm
     */
    public String updateByPrimaryKeySelective(MonitorJvm record) {
        SQL sql = new SQL();
        sql.UPDATE("monitor_jvm");
     ...
     * This method corresponds to the database table monitor_jvm
     */
    protected void applyWhere(SQL sql, MonitorJvmExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
