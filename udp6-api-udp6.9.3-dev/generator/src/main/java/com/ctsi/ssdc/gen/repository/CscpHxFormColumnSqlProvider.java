...
import com.ctsi.ssdc.gen.domain.CscpHxFormColumnExample.Criteria;
import com.ctsi.ssdc.gen.domain.CscpHxFormColumnExample.Criterion;
...
*/
public class CscpHxFormColumnSqlProvider {
     ...
     */
    public String countByExample(CscpHxFormColumnExample example) {
        SQL sql = new SQL();
        sql.SELECT("count(*)").FROM("cscp_hx_form_column");
     ...
     * @mbg.generated Thu Feb 17 14:02:06 CST 2022
     */
    public String deleteByExample(CscpHxFormColumnExample example) {
        SQL sql = new SQL();
        sql.DELETE_FROM("cscp_hx_form_column");
        applyWhere(sql, example, false);
        return sql.toString();
    }
     ...
     * @mbg.generated Thu Feb 17 14:02:06 CST 2022
     */
    public String insertSelective(CscpHxFormColumn record) {
        SQL sql = new SQL();
        sql.INSERT_INTO("cscp_hx_form_column");
        ...
        if (record.getColumnOldName() != null) {
            sql.VALUES("column_name_old", "#{columnOldName,jdbcType=VARCHAR}");
        }
        ...
        if (record.getIsQuery() != null) {
            sql.VALUES("is_query", "#{isQuery,jdbcType=INTEGER}");
        }
        ...
        if (record.getControlLength() != null) {
            sql.VALUES("control_length", "#{controlLength,jdbcType=VARCHAR}");
        }
     ...
     * @mbg.generated Thu Feb 17 14:02:06 CST 2022
     */
    public String selectByExample(CscpHxFormColumnExample example) {
        SQL sql = new SQL();
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        CscpHxFormColumn record = (CscpHxFormColumn) parameter.get("record");
        CscpHxFormColumnExample example = (CscpHxFormColumnExample) parameter.get("example");
        
        SQL sql = new SQL();
        sql.UPDATE("cscp_hx_form_column");
        
        if (record.getColumnId() != null) {
            sql.SET("column_id = #{record.columnId,jdbcType=BIGINT}");
        }
        ...
        if (record.getColumnOldName() != null) {
            sql.SET("column_name_old = #{record.columnOldName,jdbcType=VARCHAR}");
        }
        ...
        if (record.getColumnType() != null) {
            sql.SET("column_type = #{record.columnType,jdbcType=INTEGER}");
        }
        
        if (record.getColumnLength() != null) {
            sql.SET("column_length = #{record.columnLength,jdbcType=BIGINT}");
        }
        
        if (record.getPointLength() != null) {
            sql.SET("point_length = #{record.pointLength,jdbcType=INTEGER}");
        }
        
        if (record.getIsPk() != null) {
            sql.SET("is_pk = #{record.isPk,jdbcType=INTEGER}");
        }
        ...
        if (record.getIsNull() != null) {
            sql.SET("is_null = #{record.isNull,jdbcType=INTEGER}");
        }
        ...
        if (record.getIsList() != null) {
            sql.SET("is_list = #{record.isList,jdbcType=INTEGER}");
        }
             if (record.getIsList() != null) {
            sql.SET("is_form = #{record.isForm,jdbcType=INTEGER}");
        }

        if (record.getIsQuery() != null) {
            sql.SET("is_query = #{record.isQuery,jdbcType=INTEGER}");
        }
        ...
        if (record.getQueryType() != null) {
            sql.SET("query_type = #{record.queryType,jdbcType=VARCHAR}");
        }
        
        if (record.getControlLength() != null) {
            sql.SET("control_length = #{record.controlLength,jdbcType=VARCHAR}");
        }
        ...
        if (record.getValidateRule() != null) {
            sql.SET("validate_rule = #{record.validateRule,jdbcType=VARCHAR}");
        }
     ...
     * @mbg.generated Thu Feb 17 14:02:06 CST 2022
     */
    public String updateByPrimaryKeySelective(CscpHxFormColumn record) {
        SQL sql = new SQL();
        sql.UPDATE("cscp_hx_form_column");
        ...
        if (record.getColumnOldName() != null) {
            sql.SET("column_name_old = #{columnOldName,jdbcType=VARCHAR}");
        }
        ...
        if (record.getIsQuery() != null) {
            sql.SET("is_query = #{isQuery,jdbcType=INTEGER}");
        }
        ...
        if (record.getControlLength() != null) {
            sql.SET("control_length = #{controlLength,jdbcType=VARCHAR}");
        }
     ...
     * @mbg.generated Thu Feb 17 14:02:06 CST 2022
     */
    protected void applyWhere(SQL sql, CscpHxFormColumnExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
